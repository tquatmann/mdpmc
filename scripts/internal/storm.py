...
def get_configurations():
    ...
    cfgs.append(Configuration(id="pi-mono-gmres-jacobi", note="PI with qmr as LinEqSolver,", command="--minmax:method pi --eqsolver gmm++ --gmm++:method jacobi"))
    ...
    cfgs.append(Configuration(id="pi-topo-gmres-topo", note="PI (topological) with gmres as LinEqSolver (non-topo)", command="--minmax:method topological --topological:minmax pi --eqsolver gmm++"))
