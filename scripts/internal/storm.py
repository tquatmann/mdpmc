...
def get_configurations():
    ...
    cfgs.append(Configuration(id="pi-topo-lu", note="PI with LU as LinEqSolver, topological solving", command="--minmax:method topological --topological:minmax pi --eqsolver eigen --eigen:method sparselu"))
    ...
    cfgs.append(Configuration(id="pi-topo-ovi", note="PI with OVI as LinEqSolver, topological solving", command="--minmax:method topological --topological:minmax pi  --eqsolver native --native:method ovi --sound"))
    ...
    cfgs.append(Configuration(id="pi-topo-vi", note="PI with VI as LinEqSolver, topological solving", command="--minmax:method topological --topological:minmax pi  --eqsolver native --native:method power"))
    cfgs.append(Configuration(id="vi2pi-mono-gmres", note="PI with gmres as LinEqSolver using VI warm-start", command="--minmax:method vi-to-pi"))
    cfgs.append(Configuration(id="vi2pi-mono-exactlu", note="PI with LU as LinEqSolver (exact) using VI warm-start", command="--minmax:method vi-to-pi --exact"))
